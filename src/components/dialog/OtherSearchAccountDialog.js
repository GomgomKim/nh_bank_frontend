...
class OtherSearchAccountDialog extends Component {
    constructor(props) {
        super(props)
        this.state = {
            list: [],
    ...
    otherSearchAccount = () => {
        ...
        //클라이언트 POST API 요청
        axios.post('https://developers.nonghyup.com/InquireDepositorOtherBank.nh', {
            "Header": {
            ...
            <React.Fragment>
                ...
                <div className="registBike-Dialog">
                    ...
                    <div className="dialog-content">
                        ...
                        <Form ref={this.formRef} onFinish={this.otherSearchAccount}>
...
export default OtherSearchAccountDialog;