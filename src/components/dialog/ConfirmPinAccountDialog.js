...
class ConfirmPinAccountDialog extends Component {
    constructor(props) {
        super(props)
        this.state = {
            list: [],
    ...
    confirmPinAccount = () => {
        ...
        //클라이언트 POST API 요청
        axios.post('https://developers.nonghyup.com/CheckOpenFinAccountDirect.nh', {
            "Header": {
            ...
            "Rgno": this.formRef.current.getFieldsValue().Rgno,
            "BrdtBrno": this.formRef.current.getFieldsValue().BrdtBrno
          })
        //성공시 then 실행
            ...
            <React.Fragment>
                ...
                <div className="registBike-Dialog">
                    ...
                    <div className="dialog-content">
                        ...
                        <Form ref={this.formRef} onFinish={this.confirmPinAccount}>
...
export default ConfirmPinAccountDialog;