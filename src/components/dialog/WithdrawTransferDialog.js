...
class WithdrawTransferDialog extends Component {
    constructor(props) {
        super(props)
        this.state = {
            list: [],
    ...
    withdrawTransfer = () => {
        ...
        axios.post('https://developers.nonghyup.com/DrawingTransfer.nh', {
            ...
            "FinAcno": this.formRef.current.getFieldsValue().FinAcno,
            ...
            <React.Fragment>
                ...
                <div className="registBike-Dialog">
                    ...
                    <div className="dialog-content">
                        ...
                        <Form ref={this.formRef} onFinish={this.withdrawTransfer}>
...
export default WithdrawTransferDialog;