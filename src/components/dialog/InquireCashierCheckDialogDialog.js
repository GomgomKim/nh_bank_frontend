...
class InquireCashierCheckDialog extends Component {
    constructor(props) {
        super(props)
        this.state = {
            list: [],
    ...
    inquireCashierCheck = () => {
        ...
        //클라이언트 POST API 요청
        axios.post('https://developers.nonghyup.com/InquireCashierCheck.nh', {
            "Header": {
              "ApiNm": "InquireCashierCheck",
              "Tsymd": curDate,
              "Trtm": "112428",
            ...
            <React.Fragment>
                ...
                <div className="registBike-Dialog">
                    ...
                    <div className="dialog-content">
                        ...
                        <Form ref={this.formRef} onFinish={this.inquireCashierCheck}>
...
export default InquireCashierCheckDialog;