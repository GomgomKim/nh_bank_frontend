...
class ConfirmPinCardDialog extends Component {
    constructor(props) {
        super(props)
        this.state = {
            list: [],
    ...
    confirmPinCard = () => {
        ...
        //클라이언트 POST API 요청
        axios.post('https://developers.nonghyup.com/CheckOpenFinCardDirect.nh', {
            "Header": {
            ...
            "Rgno": this.formRef.current.getFieldsValue().Rgno,
            "Brdt": this.formRef.current.getFieldsValue().Brdt
          })
        //성공시 then 실행
            ...
            <React.Fragment>
                ...
                <div className="registBike-Dialog">
                    ...
                    <div className="dialog-content">
                        ...
                        <Form ref={this.formRef} onFinish={this.confirmPinCard}>
...
export default ConfirmPinCardDialog;