...
class InquireExchangeRateDialog extends Component {
    constructor(props) {
        super(props)
        this.state = {
            list: [],
    ...
    inquireExchangeRate = () => {
        ...
        //클라이언트 POST API 요청
        axios.post('https://developers.nonghyup.com/InquireExchangeRate.nh', {
            "Header": {
            ...
            <React.Fragment>
                ...
                <div className="registBike-Dialog">
                    ...
                    <div className="dialog-content">
                        ...
                        <Form ref={this.formRef} onFinish={this.inquireExchangeRate}>
...
export default InquireExchangeRateDialog;