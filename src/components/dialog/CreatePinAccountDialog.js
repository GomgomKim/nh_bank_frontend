...
class CreatePinAccountDialog extends Component {
    constructor(props) {
        super(props)
        this.state = {
            list: [],
    ...
    createPinAccount = () => {
        ...
        let self = this;
        //클라이언트 POST API 요청
        axios.post('https://developers.nonghyup.com/OpenFinAccountDirect.nh', {
            "Header": {
            ...
            <React.Fragment>
                ...
                <div className="registBike-Dialog">
                    ...
                    <div className="dialog-content">
                        ...
                        <Form ref={this.formRef} onFinish={this.createPinAccount}>
...
export default CreatePinAccountDialog;