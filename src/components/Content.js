      ...
      <Layout.Content>
        <div style={{ padding: 24, background: "#fff" }}>
          <Switch>
            ...
            <Route
              exact
              path="/settlement/LeaseDeposit"
              component={LeaseDeposit}
            />
            <Route
              exact
              path="/settlement/InsuranceDeposit"
              component={InsuranceDeposit}
            />
            <Route
              exact
              path="/settlement/DeliveryCost"
              component={DeliveryCost}
            />
            <Route exact path="/settlement/FeeDeposit" component={FeeDeposit} />
            <Route
              exact
              path="/settlement/FrDuesDeposit"
              component={FrDuesDeposit}
            />
            <Route
              exact
              path="/settlement/SellProdDeposit"
              component={SellProdDeposit}
            />
            <Route exact path="/settlement/NcashFee" component={NcashFee} />
